/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 9a0788ce8517668f7cfc62ce9615e111)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	DYB_PRO_API_KEY: string;
	BACKEND: Fetcher /* dyb-pro-api */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DYB_PRO_API_KEY">> {}
}
