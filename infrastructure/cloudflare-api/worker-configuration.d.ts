/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 83d18deab023af9c1aa6c2a54510a369)
...
interface __BaseEnv_CloudflareEnv {
	...
	DEVIN_CHILD_REPO: "https://github.com/yacine-baghli/DYB-Pro";
	DEVIN_ORCHESTRATOR_ACU_LIMIT: "8";
	DEVIN_CHILD_ACU_LIMIT: "5";
	DEVIN_POLL_INTERVAL_SECONDS: "10";
	DEVIN_SESSION_TIMEOUT_SECONDS: "1800";
	DEVIN_REQUEST_TIMEOUT_SECONDS: "60";
	AGENT_MAX_ATTEMPTS: "2";
	OPENAI_MODEL: "gpt-4.1-mini";
	OPENAI_VISION_MODEL: "gpt-4.1-mini";
	ALPHAFOLD_MODEL_VERSION: "alphafold2-nim";
	ALPHAFOLD_TIMEOUT_SECONDS: "3600";
	PROTEINMPNN_MODEL_VERSION: "proteinmpnn-nim";
	PROTEINMPNN_TIMEOUT_SECONDS: "900";
	PROTEINMPNN_NUM_SEQUENCES: "8";
	PROTEINMPNN_SAMPLING_TEMPERATURE: "0.1";
	PROTEINMPNN_RANDOM_SEED: "37";
	RESEARCH_DAEMON_ENABLED: "true";
	RESEARCH_DEBOUNCE_SECONDS: "5";
	RESEARCH_TICK_SECONDS: "15";
	RESEARCH_ACU_LIMIT: "3";
	RESEARCH_MAX_TOPICS_PER_EVENT: "4";
	DAEMON_ENABLED: "true";
	DAEMON_TICK_SECONDS: "5";
	DAEMON_DEBOUNCE_SECONDS: "6";
	DAEMON_MAX_ATTEMPTS: "3";
	DAEMON_CHILD_ACU_LIMIT: "4";
	DAEMON_CHILD_TIMEOUT_SECONDS: "420";
	DAEMON_LITERATURE_NETWORK: "true";
	PUBLIC_API_BASE: "http://localhost:8000";
	PHARMA_DAEMON_FREQUENCY: "daily";
	S3_BUCKET: "dyb-pro-artifacts";
	S3_REGION: "auto";
	LOCAL_ARTIFACT_DIR: "/tmp/dyb-pro-artifacts";
	DEFAULT_ACU_QUOTA: "200";
	DEFAULT_CYCLE_QUOTA: "25";
	DATABASE_URL: string;
	REDIS_URL: string;
	CORS_ORIGINS: string;
	...
	ALPHAFOLD_API_URL: string;
	ALPHAFOLD_API_KEY: string;
	PROTEINMPNN_API_URL: string;
	PROTEINMPNN_API_KEY: string;
	S3_ENDPOINT_URL: string;
	S3_ACCESS_KEY: string;
	S3_SECRET_KEY: string;
	SEED_ADMIN_API_KEY: string;
	SEED_SCIENTIST_API_KEY: string;
	SEED_VIEWER_API_KEY: string;
	DYB_PRO_CONTAINER: DurableObjectNamespace<import("./src/index").DybProContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DybProContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "LOG_LEVEL" | "CELERY_TASK_ALWAYS_EAGER" | "ALLOW_LOCAL_SIMULATION" | "DEVIN_API_BASE" | "DEVIN_API_FLAVOR" | "DEVIN_APP_BASE" | "DEVIN_CHILD_REPO" | "DEVIN_ORCHESTRATOR_ACU_LIMIT" | "DEVIN_CHILD_ACU_LIMIT" | "DEVIN_POLL_INTERVAL_SECONDS" | "DEVIN_SESSION_TIMEOUT_SECONDS" | "DEVIN_REQUEST_TIMEOUT_SECONDS" | "AGENT_MAX_ATTEMPTS" | "OPENAI_MODEL" | "OPENAI_VISION_MODEL" | "ALPHAFOLD_MODEL_VERSION" | "ALPHAFOLD_TIMEOUT_SECONDS" | "PROTEINMPNN_MODEL_VERSION" | "PROTEINMPNN_TIMEOUT_SECONDS" | "PROTEINMPNN_NUM_SEQUENCES" | "PROTEINMPNN_SAMPLING_TEMPERATURE" | "PROTEINMPNN_RANDOM_SEED" | "RESEARCH_DAEMON_ENABLED" | "RESEARCH_DEBOUNCE_SECONDS" | "RESEARCH_TICK_SECONDS" | "RESEARCH_ACU_LIMIT" | "RESEARCH_MAX_TOPICS_PER_EVENT" | "DAEMON_ENABLED" | "DAEMON_TICK_SECONDS" | "DAEMON_DEBOUNCE_SECONDS" | "DAEMON_MAX_ATTEMPTS" | "DAEMON_CHILD_ACU_LIMIT" | "DAEMON_CHILD_TIMEOUT_SECONDS" | "DAEMON_LITERATURE_NETWORK" | "PUBLIC_API_BASE" | "PHARMA_DAEMON_FREQUENCY" | "S3_BUCKET" | "S3_REGION" | "LOCAL_ARTIFACT_DIR" | "DEFAULT_ACU_QUOTA" | "DEFAULT_CYCLE_QUOTA" | "DATABASE_URL" | "REDIS_URL" | "CORS_ORIGINS" | "DEVIN_API_KEY" | "DEVIN_ORG_ID" | "OPENAI_API_KEY" | "ALPHAFOLD_API_URL" | "ALPHAFOLD_API_KEY" | "PROTEINMPNN_API_URL" | "PROTEINMPNN_API_KEY" | "S3_ENDPOINT_URL" | "S3_ACCESS_KEY" | "S3_SECRET_KEY" | "SEED_ADMIN_API_KEY" | "SEED_SCIENTIST_API_KEY" | "SEED_VIEWER_API_KEY">> {}
}
